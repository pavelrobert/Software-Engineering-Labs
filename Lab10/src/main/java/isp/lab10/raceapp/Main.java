...
public class Main {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("Dacia Logan", carPanel, semaphoreThread,rankingPanel,frame2);
        Car car2 = new Car("Skoda Octavia", carPanel, semaphoreThread,rankingPanel,frame2);
        Car car3 = new Car("Subaru", carPanel, semaphoreThread,rankingPanel,frame2);
        Car car4 = new Car("Lada", carPanel, semaphoreThread,rankingPanel,frame2);
